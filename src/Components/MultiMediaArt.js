...
const MultiMediaArt = () => {
  return (
    <div className='ui grid'>
      ...
      <iframe src="https://player.vimeo.com/video/46844898" width="640" height="472" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
      ...
      <div>
        <h3>Babel</h3>
      <iframe src="https://player.vimeo.com/video/46844899" width="640" height="472" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
      ...
      <div>
        <h3>Montage</h3>
        <iframe src="https://player.vimeo.com/video/46826845" width="640" height="472" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
      ...
      <div>
        ...
        <iframe width="560" height="315" src="https://www.youtube.com/embed/X6P6OKUe7MA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </div>
      </div>
    </div>
 )
